      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-12 md:py-16">
        ...
        <section className="mb-14">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {LEARNING_PATH_LINKS.map((path) => (
              <Link
                key={path.to}
                to={path.to}
                className="bg-white rounded-2xl border border-[#E5E7EB] p-5 shadow-sm hover:shadow-md transition-shadow"
              >
                <h3 className="font-bold text-[#1B2F5E] text-sm mb-2">{path.label}</h3>
                <p className="text-xs text-[#6B7280] mb-3">12 guided lessons · Ages 5–16</p>
