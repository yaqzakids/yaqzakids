import { getDailyDuaForDate, type DailyDuaEntry } from '@/lib/parent/dailyDuaContent'
...
export default function DailyDuaCard({
  ...
  const dua = entry ?? getDailyDuaForDate()
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E2EBF8] shadow-sm overflow-hidden">
      <div className="bg-gradient-to-r from-[#1B2F5E] to-[#243B6E] px-5 py-4">
        ...
        <h3 className="font-display text-lg font-bold text-white">Today&apos;s Reminder</h3>
      </div>
