...
-- Server-side TTS audio cache metadata (audio bytes stored in Supabase Storage)
...
-- Storage bucket for cached TTS audio (private; accessed via Edge Function service role)
