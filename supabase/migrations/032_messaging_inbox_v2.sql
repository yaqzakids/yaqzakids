-- Messaging inbox v2: 1:1 conversations, folders, metadata, delivery fix
...
-- Backfill parent_user_id from participant rows
...
-- One conversation per parent (fixes shared-thread delivery confusion)
